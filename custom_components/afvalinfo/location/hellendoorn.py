...
class HellendoornAfval(object):
    def get_data(self, city, postcode, street_number, resources):
        ...
        try:
            ...
            companyCode = SENSOR_LOCATIONS_TO_COMPANY_CODE["hellendoorn"]

            #######################################################
            # First request: get uniqueId and community
            API_ENDPOINT = SENSOR_LOCATIONS_TO_URL["hellendoorn"][0]
            ...
            API_ENDPOINT = SENSOR_LOCATIONS_TO_URL["hellendoorn"][1]
