...
class AvalexAfval(object):
    def get_data(self, city, postcode, street_number, resources):
        ...
        try:
            ...
            API_ENDPOINT = SENSOR_LOCATIONS_TO_URL["avalex"][0].format(
            ...
            API_ENDPOINT = SENSOR_LOCATIONS_TO_URL["avalex"][1].format(
