...
class AfvalinfoData(object):
    ...
    def update(self):
        ...
        mijnafvalwijzer = ["aarle", "abcoude", "achterveld", "aerdt", "akersloot", "almkerk", "altena", "alteveer", "alteveer", "amen", "america", "amstelhoek", "amstelveen", "amstenrade", "andel", "anderen", "angerlo", "anloo", "annen", "annerveenschekanaal", "anreep-schieven", "ansen", "assen", "baambrugge",
        "baarschot", "babberich", "babylonienbroek", "bad nieuweschans", "baexem", "bahr", "bakkum", "bakkum-noord", "balloerveld", "balloo", "barneveld", "beegden", "beek", "beerta", "beesel", "benschop", "bergen op zoom", "berghuizen", "bergschenhoek", "berkel en rodenrijs", "best", "bevermeer", "biddinghuizen",
        "biest-houtakker", "bilthoven", "bingelrade", "bingerden", "blauwestad", "bleiswijk", "boerdonk", "borger", "boskant", "bosschenhoofd", "bovenveen", "boxtel", "breda", "brielle", "broekhorn", "broekhuizen", "broekhuizenvorst", "bronneger", "bronnegerveen", "buggenum", "buinen", "buinerveen", "cabauw",
        "castricum aan zee", "castricum", "de beek", "de bilt", "de glind", "de hoef", "de meern", "de moer", "de noord", "de steeg", "de vleut", "de vorst", "de wijk", "de woude", "den berg", "deurze", "dieren", "diessen", "doenrade", "doetinchem", "dongen", "dongense vaart", "doornspijk", "draai", "drie", "drieborg",
        "drogteropslagen", "drongelen", "dronten", "drouwen", "drouwenermond", "drouwenerveen", "duiven", "dusseldorp", "dussen", "echten", "eekt", "een", "een-west", "eerde", "eerste exloermond", "ees", "eesergroen", "eeserveen", "eethen", "eext", "eexterveen", "eexterveenschekanaal", "eexterzandvoort", "ekehaar",
        "elburg", "eldersloo", "eleveld", "ell", "ellecom", "ellertshaar", "elspeet", "ermelo", "erp", "esbeek", "etten-leur", "eursinge", "evertsoord", "exloo", "exloërveen", "fijnaart", "finsterwolde", "fort", "foxhol", "foxwolde", "froombosch", "gaanderen", "garderen", "gasselte", "gasselternijveen",
        "gasselternijveenschemond", "gasteren", "geelbroek", "geertruidenberg", "genderen", "genhout", "geverik", "giesbeek", "giessen", "gieten", "gieterveen", "gilze", "goirle", "grafhorst", "graswijk", "grathem", "griendtsveen", "groenekan", "groessen", "grolloo", "grubbenvorst", "haarzuilens", "haelen", "haghorst",
        "haler", "hank", "harderwijk", "harkstede", "hattemerbroek", "heel", "heerhugowaard", "heesch", "heeswijk-dinther", "hegelsom", "heibloem", "heijningen", "heiligerlee", "heiloo", "hellum", "helwijk", "herwen", "heythuysen", "hezelaar", "hierden", "hilvarenbeek", "hoevelaken", "hoeven", "hollandsche rading",
        "hoogezand", "horn", "horst", "houtdorp", "houten", "huis ter heide", "hulsberg", "hulshorst", "hulten", "hunsel", "ijsselmuiden", "ittervoort", "jaarsveld", "jabeek", "kaatsheuvel", "kampen", "kamperveen", "kasteren", "keldonk", "kelmond", "kelpen-oler", "kerkdorp", "kerkenveld", "kiel-windeweer", "kinderbos",
        "klein-dongen", "klijndijk", "klundert", "koekange", "koekangerveld", "kolham", "kootwijk", "kootwijkerbroek", "krimpen aan den ijssel", "kronenberg", "kropswolde", "kruisweg", "laag-soeren", "langelo", "langenberg", "langeweg", "lapstreek", "lathum", "leiden", "leiderdorp", "lennisheuvel", "leusden",
        "leusden-zuid", "leutingewolde", "leuvenum", "liempde", "lieveren", "limmen", "linde", "linne", "lobith", "loo", "looeind", "loon op zand", "loon", "loosbroek", "lopik", "lopikerkapel", "lottum", "luddeweer", "luissel", "maartensdijk", "maasbracht", "mariaheide", "marwijksoord", "matsloot", "meeden",
        "meerlo", "meeuwen", "melderslo", "merkelbeek", "meterik", "midwolda", "mijdrecht", "moerdijk", "molenschot", "mullegen", "muntendam", "neer", "neerbeek", "neeritter", "nergena", "nes aan de amstel", "nietap", "nieuw annerveen", "nieuw-beerta", "nieuw-buinen", "nieuw-roden", "nieuw-scheemda", "nieuw-wehl",
        "nieuwediep", "nieuwendijk", "nieuwolda", "nijkerk", "nijkerkerveen", "nijlande", "nijnsel", "nistelrode", "nooitgedacht", "noordbroek", "noordeinde", "noordhoek", "norg", "nunhem", "nunspeet", "nuth", "odoorn", "odoornerveen", "offenbeek", "ohe en laak", "oirsbeek", "oldebroek", "olland", "oosteinde",
        "oosterwolde", "oostwold", "ooy", "oud annerveen", "oud gastel", "oud-zevenaar", "ouddorp", "oudemolen", "oudenbosch", "oudezijl", "overschild", "pannerden", "papenvoort", "peest", "peize", "peizermade", "peizerwold", "polsbroek", "polsbroekerdam", "posthoorn", "puth", "raamsdonk", "raamsdonksveer",
        "reuver", "rheden", "rhee", "riel", "rijen", "rijkel", "rijswijk", "roden", "rodenrijs", "roderesch", "roderwolde", "roermond", "roggel", "rolde", "roond", "rotte", "rotterdam", "ruinen", "ruinerwold", "s gravenmoer", "s-gravenmoerse vaart", "s-heerenbroek", "sandebuur", "sappemeer", "schalkwijk",
        "scharmer", "scheemda", "schijndel", "schildwolde", "schimmert", "schinnen", "schinveld", "schipborg", "schoonloo", "selissen", "sevenum", "siddeburen", "sint-oedenrode", "sleeuwijk", "slochteren", "spankeren", "spaubeek", "speuld", "spijk", "spijkerboor", "stampersgat", "standdaarbuiten", "staverden",
        "steenbergen", "steendam", "stevensweert", "stoutenburg", "stroe", "swalmen", "sweikhuizen", "swifterbant", "swolgen", "t goy", "t harde", "t loo", "telgt", "ter aard", "terheijl", "terschuur", "thorn", "tienray", "tjuchem", "tolkamer", "tongeren", "tonnekreek", "tonsel", "tripscompagnie", "trutjeshoek",
        "tuindorp", "tull en t waal", "tweede exloermond", "tweede valthermond", "ubbena", "uitweg", "uitwijk", "uppel", "utrecht", "valthe", "valthermond", "veen", "veenhuizen", "veenhuizen", "veeningen", "veghel", "velp", "verlaat", "vierhouten", "vierpolders", "vinkel", "vinkeveen", "vleuten", "voorthuizen",
        "vorstenbosch", "voskuil", "vredenheim", "vrilkhoven", "waardhuizen", "waterhuizen", "waverveen", "wehl", "werkendam", "wessem", "westbroek", "westdorp", "westerbroek", "westerlee", "westervelde en zuidvelde", "wezep", "wijbosch", "wijk en aalburg", "wijnandsrade", "wijnbergen", "willemstad", "willige langerak",
        "wilnis", "wilsum", "winschoten", "witten", "woudbloem", "woudrichem", "zalk", "zandberg", "zeijerveld", "zevenaar", "zevenbergschen hoek", "zijtaart", "zuidbroek", "zuidwolde", "zwartebroek", "zwartewaal"]
